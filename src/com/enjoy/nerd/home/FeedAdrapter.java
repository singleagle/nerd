...
public class FeedAdrapter extends BaseAdapter {
	...
	private ArrayList<RecommendFeed> mFeedList = new ArrayList<RecommendFeed>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if(convertView == null){
			convertView = LayoutInflater.from(mContext).inflate(R.layout.recommend_feed_item, parent, false);
