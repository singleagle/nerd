...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    protected static final int SEND_EXCEPTION=7;
    ...
    static class ResponderHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            AsyncHttpResponseHandler service = mResponder;
            
            if (service != null) {
                service.handleMessage(msg);
            }else{
            	Log.e(LOG_TAG, "mResponder is null");
            }
        }
    }
    ...
    /**
     * Fired when the request start to read data from network data stream
     * */
    public void onRead(){
    }
    ...
    public void onRequestUrlChanged(String url){
    }
    
    public void onSendException(Throwable e){
    ...
    final public void sendRequestUrlChanged(String url){
    	onRequestUrlChanged(url);
    }
  
    final public void sendException(Throwable throwable){
    	//sendMessage(obtainMessage(SEND_EXCEPTION, throwable));
    	onSendException(throwable);
    }
